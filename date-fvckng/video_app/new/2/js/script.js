...
let videoCount = 180; //DEV
let loadedVideos = 0; // Video download counter
var whatAdsPlayNext = 1;
var adsCount = 5;
var whatPlayModeNow = 0; //0: 3vids 1ad, 1: 1vid 1ad;

const avatarRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/tmm7y5zqt?key=19cc3dc98c59f4d4b8196788f810d55a";
const commentRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/j0ekcjzfqd?key=544806fd7f6aa2be05271f9c2b550687";
const DatingIconRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/p2d1hzt7w9?key=48eaead271ad14cc9d79a5d8d8ef3933";
const camsIconRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/afzpz6jw?key=d77c406fd419d45b73637d54c18eb7ac";
const utilityIconRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/kgc3ihab?key=ba414ea2c9a6da428b3b3e27c8fbe563";
const backBtnRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/ra5b2k953?key=e05289e6cf9cea91d76b5dd922c99423";
const logoRedirectUrl = "http://sollospell22.netlify.app/DONGGLENG?/muwj96qe?key=d8d0e0595c86cd35d1fc8f14b8fc7ead";
...
var adsVideo = {
    1: {
        'adsHref': 'http://sollospell22.netlify.app/DONGGLENG?/yftgswnb?key=e50b5769a3e3bd9deeab999d6698030a'
    },
    2: {
        'adsHref': 'http://sollospell22.netlify.app/DONGGLENG?/z607numn?key=c6906a221f0f612752332bfa2c8ff9ee'
    },
    3: {
        'adsHref': 'http://sollospell22.netlify.app/DONGGLENG?/h7pe7kvj9?key=f62b9b512f810ec614a5c949da5ac60e'
    },
    4: {
        'adsHref': 'http://sollospell22.netlify.app/DONGGLENG?/mvuh398v5e?key=e9b0bb023e5550d7e4c156e6830ebb13'
    },
    5: {
        'adsHref': 'http://sollospell22.netlify.app/DONGGLENG?/pj6rzr2i9?key=6c074b318df9f3b5633d7f84e3694b39'
    },
};
    ...
    videoBlock.innerHTML = `
         <div class="left-icons">
            ...
            <div class="bottom_icons">
                <div class="avatar">
                    <img src="${src}" alt="" style="border: 2px solid ${color};">
        ...
        <video ${isMuted} playsinline='' autoplay="" loop class="fullscreen-bg__video" data-video-url="${randomVideoNumber}" src="https://fuck-date-app.com/video_app/videos/1/${randomVideoNumber}.mp4">
        ...
        <div class="desc">
            ...
            <div class="desc_text">More Than 1000+ porno videos in APP</div>
        </div>
    `;
...
function createAdsBlockV2() {
    ...
    adsBlock.innerHTML = `<video ${isMuted} playsinline='' autoplay="" class="fullscreen-bg__video ads_video" data-ads-num="${adsNumber}" src="https://fuck-date-app.com/video_app/adsVideo/${adsNumber}.mp4">
        <source src="" type="video/mp4">
    </video>
...
function copyPageUrl(evt) {
    if (!evt.target.classList.contains('share') &&
        !evt.target.classList.contains('share__img')
    ) {
        return false;
    }
    const currentUrl = window.location.href; // Get the current page URLчаем текущий URL страницы
    navigator.clipboard.writeText(currentUrl) // Copy URL to clipboard
        .then(() => {
            alert('copied to clipboard'); // Message about successful copying
        })
        .catch(err => {
